...
locals {
    client_id = data.aws_ssm_parameter.dbr_client_id.value
    client_secret = data.aws_ssm_parameter.dbr_client_secret.value
    databricks_account_id = data.aws_ssm_parameter.databricks_account_id.value
}